...
ZAP_REPORT = '''<html>
    ...
    <div class="spacer"></div>
        ...
        <tr bgcolor="#e8e8e8">
        <td width="20%" class="indent2">Evidence</td><td width="80%">&lt;blablatest enctype="application/x-www-form-urlencoded"&gt;</td>
        </tr>
        <tr bgcolor="#e8e8e8">
...
class ZAPScanReportTest(unittest.TestCase):
    ...
    def test_get_warnings_info(self, mock_url_read):
        ...
        self.assertEqual([("Anti CSRF Tokens Scanner", "https://test.org/gebruikersgegevens/details.jsf", "Not supported"),
                          ("Anti CSRF Tokens Scanner", "https://test.org/scripts/jquery-3.2.1.min.js", "Not supported")], result)
    ...
    def test_high_risk_alerts(self, mock_url_read):
        ...
        mock_url_read.return_value = ZAP_REPORT
        self.assertEqual(2, self.__report.alerts('high', 'url'))
